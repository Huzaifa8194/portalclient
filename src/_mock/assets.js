...
export const _postTitles = [
  `Family Reunification Spouse, Children & Parents EU Residence`,
  `Worldwide Visit Visas Apply Now! Global Visa Services`,
  `Business & Work Permit Not just an application form`,
...
export const _sentences = [
  `Add your family member as a co-applicant to apply together with you.`,
  `One application form for multiple visa requests, perfect for your future short trips`,
  `It’s a journey. Skip forms and start planning your success`,
