        ...
        <Grid xs={12}>
          <Card sx={{ p: 3 }}>
            ...
            >
              ...
              <Field.Text name="dateOfBirth" label="Date of Birth (DD/MM/YYYY)" type="date" InputLabelProps={{ shrink: true }} />
              ...
              <Field.Select native name="validVisa" label="Do you hold a valid visa/residence permit in Europe?" InputLabelProps={{ shrink: true }}>
              ...
              {watchValidVisa === 'yes' && (
                <Field.Text name="visaDetails" label="Specify type and expiry date" />
              )}
              ...
              <Field.Select native name="residingInEurope" label="Are you currently residing in Europe?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              {watchResidingInEurope === 'yes' && (
                <Field.Text name="europeanCountry" label="Specify the country" />
              )}

              <Typography variant="subtitle1" sx={{ gridColumn: '1 / -1', mb: 2, mt: 3 }}>
                Experience and Skills
              </Typography>
              <Field.Select native name="childcareExperience" label="Do you have previous childcare or AU Pair experience?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              {watchChildcareExperience === 'yes' && (
                <Field.Text name="childcareExperienceDetails" label="Describe in detail (duties, duration, age groups)" multiline rows={3} className="full-width" />
              )}
              <Field.Select native name="driversLicense" label="Do you hold a valid driver's license?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              />
              <Field.Select native name="comfortableWithPets" label="Are you comfortable working in a household with pets?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              {watchComfortableWithPets === 'yes' && (
                <Field.Text name="petTypes" label="Specify types of pets" />
              )}
              <Field.Select native name="teachingExperience" label="Do you have teaching or tutoring experience?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              <Field.Select native name="employmentStatus" label="Current Employment Status" InputLabelProps={{ shrink: true }}>
              ...
              {watchEmploymentStatus === 'working' && (
                <Field.Text name="currentContractEnd" label="When does your current contract end?" type="date" InputLabelProps={{ shrink: true }} />
              )}
              <Field.Text name="preferredStartDate" label="Preferred start date with a new host family" type="date" InputLabelProps={{ shrink: true }} />
              <Field.Select native name="shareContactDetails" label="Are you willing to share your current host family's contact details for a reference check?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              <Field.Select native name="allergies" label="Do you have any allergies or medical conditions that the host family should be aware of?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              <Field.Text name="reasonForAuPair" label="Why do you want to become an AU Pair?" multiline rows={3} className="full-width" />
              <Field.Select native name="childcareCertifications" label="Have you completed any childcare or first-aid certifications?" InputLabelProps={{ shrink: true }}>
                {yesNoOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
                  </option>
              ...
              <Field.Text name="additionalInfo" label="Other Information You Wish to Share" multiline rows={3} className="full-width" />
